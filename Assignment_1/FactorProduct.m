...
assignmentsA=IndexToAssignment(indxA,A.card);
assignmentsB=IndexToAssignment(indxB,B.card);
products = GetValueOfAssignment(A,assignmentsA).*GetValueOfAssignment(B,assignmentsB);
C = SetValueOfAssignment(C, assignments,products) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
